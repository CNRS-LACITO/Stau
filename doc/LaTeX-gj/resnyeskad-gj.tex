...
\title{Person marking in Rtau\footnote{This paper follows the Leipzig Glossing rules, to which the following are added: \textsc{evd} evidential, \textsc{inv} inverse, \textsc{testim} testimonial (on this term see \citealt{tournadre08conjunct} and \citealt{hill13hdug}). We wish to thank two anonymous reviewers for useful comments.} }
...
\bottomrule
\end{tabular}
\caption{Vowel alternations in open-syllable intransitive verbs in Rtau}  
\end{table}
...
\bottomrule
\end{tabular}
\caption{Vowel alternations in closed syllable intransitive verbs in Rtau} \label{tab:close.intr}
\end{table}
...
\bottomrule
\end{tabular}
\caption{Irregular intransitive verbs in Rtau} 
\end{table}
...
\bottomrule
\end{tabular}
\caption{Vowel alternations in open-syllable transitive verbs in Rtau} 
\end{table}
...
\bottomrule
\end{tabular}
\caption{Vowel alternations in closed syllable transitive verbs in Rtau}  
\end{table}

All the morphophonological rules observed in this section are summarized in Table \ref{tab:alternation}.

\begin{table}[H]
\label{tab:alternation} \centering
...
\bottomrule
\end{tabular}
\caption{Vowel fusion in Rtau verbs}  
\end{table}
...
\begin{table}[H]
\label{tab:alternation.noun} \centering
\begin{tabular}{c|cccccc}
\toprule
...
\bottomrule
\end{tabular}
\caption{Vowel fusion in Rtau nouns} 
\end{table}
...
\textsc{intr}&\ipa{\ra{}-ŋ}&\ipa{\ra{}-tɕə}&\ipa{\ra{}-jə}&\ipa{tə-\ra{}}&\ipa{tə-\ra{}-ndʑə}&\ipa{tə-\ra{}-ɲə}&\ipa{\ra{}}&\ipa{\ra{}-ndʑə} &\ipa{\ra{}-ɲə}& 	\grise{} \\	
	\bottomrule
\end{tabular}}
\caption{Zbu Rgyalrong transitive and intransitive paradigms (adapted from \citealt{gongxun14agreement})}
\end{sidewaystable}
...
\bottomrule
\end{tabular}
\caption{Directional prefixes in Rtau} 
\end{table}
...
\begin{table}[H]
\label{tab:motion.irr} \centering
\begin{tabular}{lccccc}
\toprule
