...
%
%
%\subsection{The structure of person marking paradigms in Rtau} \label{sec:alignment}
%
...
%\end{exe}
%
%\subsection{Directional prefixes and stem alternation} \label{sec:dir.pref}
