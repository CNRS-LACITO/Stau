...
\highlightii{\ra le marquage direct/inverse permet une désambiguïsation totale}
...
\highlighti{\ra la symétrie dans la structure du paradigme est motivée par la hiérarchie d'empathie}
