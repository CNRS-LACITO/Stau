...
\+mkr 1s>2s
\nam First singular on second singular
\desc Used to give the vernacular for this particular paradigm form. (It is better to use the \pdl field set for this.)
\lng vernacular
\mkrOverThis ps
\CharStyle
...
\+mkr 2s>1s
\nam Second singular on first singular
\desc Used to give the vernacular for this particular paradigm form. (It is better to use the \pdl field set for this.)
\lng vernacular
\mkrOverThis ps
\CharStyle
...
\+mkr 3s>1s
\nam Third singular on first singular
\desc Used to give the vernacular for this particular paradigm form. (It is better to use the \pdl field set for this.)
\lng vernacular
\mkrOverThis ps
\CharStyle
...
\exportedEnglishDiglot D:\Dict_ed.rtf
...
\exportedFile C:\Users\crlao\Desktop\resnye.rtf
\MarkerFont
\AddAlphDiv
\+mkrsubsetIncluded 
\mkr 1s
